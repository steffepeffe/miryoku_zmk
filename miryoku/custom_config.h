...
#define MIRYOKU_LAYERMAPPING_LINUX( \
     ...
     XXX          K00  K01  K02  K03  K04       K05  K06  K07  K08  K09  &linux_ao /* å / Å */ \
...
U_LT(U_LINUX, A),  U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     &uc UC_SV_OE /* ö / Ö */,    \
