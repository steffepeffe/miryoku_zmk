...
#define MIRYOKU_LAYERMAPPING_BASE( \
     ...
     XXX  K00  K01  K02  K03  K04       K05  K06  K07  K08  K09  &kp RA(W) \
     XXX  K10  K11  K12  K13  K14       K15  K16  K17  K18  K19  &kp RA(Q) \
...
&kp A,             U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     &kp RA(P),    \
