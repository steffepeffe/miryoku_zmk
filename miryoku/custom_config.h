...
#define MIRYOKU_LAYERMAPPING_BASE( \
     ...
     &uc UC_SET_LINUX  K00  K01  K02  K03  K04       K05  K06  K07  K08  K09  &sv_ao /* å / Å */ \
     &uc UC_SET_WIN_COMPOSE  K10  K11  K12  K13  K14       K15  K16  K17  K18  K19  &sv_ae /* ä / Ä */ \
...
&kp A,             U_MT(LALT, S),     U_MT(LCTRL, D),    U_MT(LSHFT, F),    &kp G,             &kp H,             U_MT(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     &sv_oe /* ö / Ö */,    \
